...
import com.sessionbean.UtilisateurFacade;
...
public class UtilisateurController implements Serializable {
    ...
    public String create() {
        try {
           ...
           FacesMessage facesMessage = new FacesMessage("Utilisateur crée", "");
           ...
           return prepareList();
            ...
            FacesContext facesContext = FacesContext.getCurrentInstance();
           FacesMessage facesMessage = new FacesMessage("Erreur", "Utilisateur non crée");
           facesMessage.setSeverity(FacesMessage.SEVERITY_INFO);
           facesContext.addMessage(null, facesMessage);
            return null;
        }
    ...
    public String update() {
        try {
           ...
           FacesContext facesContext = FacesContext.getCurrentInstance();
           FacesMessage facesMessage = new FacesMessage("Modifié avec succés", "");
           facesMessage.setSeverity(FacesMessage.SEVERITY_INFO);
           facesContext.addMessage(null, facesMessage);
            return prepareList();
        } catch (Exception e) {
    ...
    private void performDestroy() {
        try {
           ...
           JsfUtil.addSuccessMessage("Utilisateur supprimé");
